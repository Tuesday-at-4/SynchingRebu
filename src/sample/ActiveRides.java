...
public class ActiveRides {
  ...
  public ObservableList<Rides> getRides() {
    ...
    TableView.add(new Rides("J Cole", LocalTime.of(12, 45), LocalDate.of(2019, Month.OCTOBER, 19)));
    TableView.add(new Rides("Kendrick Lamar", LocalTime.of(5, 35), LocalDate.of(2019, Month.OCTOBER, 24)));
    TableView.add(new Rides("LeBron James", LocalTime.of(6, 45), LocalDate.of(2019, Month.OCTOBER, 31)));
    return TableView;
  }
